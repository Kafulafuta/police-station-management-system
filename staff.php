    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="form-wrap">
              <h2 class="mb-5" style="color: #0000ff;">Staff</h2>
              <form action="staff.php" method="POST">
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="service_number" class="form-control py-2">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12 form-group">
                      <label for="rank">Rank</label>
                      <input type="text" name="rank" class="form-control py-2 ">
                    </div>
                  </div>
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="firstname" class="form-control py-2 ">
                    </div>
                  </div>
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="lastname" class="form-control py-2 ">
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="station" class="form-control py-2 ">
                    </div>
                  </div>
				  ...
				  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" name="nrc" class="form-control py-2 ">
                    </div>
                  </div>
