        ...
        <div class="row align-items-center justify-content-center site-hero-sm-inner">
          <div class="col-md-7 text-center">
            ...
            <div class="mb-5 element-animate">
              <h1 class="mb-2">Display staff Details</h1>
              <p class="bcrumb"><a href="index.php">Home</a> <span class="sep ion-android-arrow-dropright px-2"></span>  <span class="current">Display staff</span></p>
            </div>
    ...
    <section class="site-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-15">
            <div class="form-wrap">
              <h2 class="mb-5" style="color: #0000ff;">Display Staff</h2>
...
if(isset($_POST['submit']))
{
	...
	$sql="SELECT * FROM staff WHERE service_number LIKE '%$searchkey%' or lastname LIKE '%$searchkey%'";
}else{
...
while($row=mysqli_fetch_array($query))
{
	...
	echo "<td><a href='deletestaff.php?id=$row[id]' onclick='return checkdelete()'>Delete</a></td>";
...
{
	return confirm('Are You Sure You Want To Delete staff officer???');
}
</script>
